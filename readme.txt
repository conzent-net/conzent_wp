...
– **Auto-translation**: Auto-translate the banner in 30+ languages as per the user’s browser language.

– **Integration with Conzent Web App**: Free connection with Conzent web app to access advanced features (cookie scan, consent log, etc.) and manage all settings from the web app account.
...
== The Conzent GDPR Cookie Consent Plugin Uses The Following Cookie Only ==

– "conzentConsent" – Conzent sets this cookie to remember users' consent preferences so that their preferences are respected on their subsequent visits to this site. It does not collect or store any personal information of the site visitors.


== Setup Guide ==

Our [WordPress cookie plugin user guide](https://conzent.net/installation-guide/#plugins "Help - Installation Guide") will help you set up the plugin on your website.


== Useful links ==

[Plugin FAQ](https://conzent.net/pricing/#faq)
[GDPR cookie consent](https://conzent.net/understanding-gdpr-in-a-nutshell/)
[Cookie Law](https://conzent.net/the-complete-guide-to-ccpa-compliance/)
[Cookie banner guide](https://conzent.net/the-complete-guide-to-cookie-banners/)

== Conzent Cookie banner plugin premium features ==
...
Note: If you connect your site to the Conzent web app, you have to replace the shortcode with an HTML code.
...
– Search for “Conzent Cookie Banner” and **Install Now**.

– Click **Activate** to enable the plugin.

= Manual installation =

– Download the Conzent Cookie Banner plugin zip file from the WordPress.org page.
...
= To connect the plugin to the Conzent web app: =


– After activating the plugin, it will automatically verify domain and setup adavanced setting from web app account.
...
1. Cookie consent banner web setting on the user-end
...
= 1.0.5 =
* Edited the readme with clarification to the 3rd.party services

= 1.0.4 =
* manually get website info by website key
* removed auto fetch website info
